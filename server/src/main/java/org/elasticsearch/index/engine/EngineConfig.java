...
public final class EngineConfig {
    ...
    /**
     * 返回{@link org.elasticsearch.index.store.Store}实例，
     * 该实例提供对用于引擎的{@link org.apache.lucene.store.Directory}的访问{@link org.apache.lucene.index.IndexWriter} 将它的索引文件写入。
     * <p>
